...
exports.findByNAME = (name, result) => {
    ...
    var sql2 = 'SELECT clo_id, clo_name, clo_image, clo_style, clo_size FROM clothes WHERE clo_name LIKE ?;';
    var sql2s = sql.format(sql2, '%'+name+'%');

    var sql3 = 'SELECT cody_id, cody_name, cody_style, cody_image FROM cody WHERE cody_name LIKE ?;';
